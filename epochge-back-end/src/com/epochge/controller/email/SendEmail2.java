package com.epochge.controller.email;// 文件名 SendEmail.java
...
public class SendEmail2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        // String myEmailAccount = "bpvank@qq.com";
        ...
        */
        ...
        try {
            message = createMimeMessage(session, "epochgenet@qq.com", registerEmail,content);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            transport.connect("epochgenet@qq.com", "forpkiepfesmdfbe");
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "验证码", "UTF-8"));
        // 3.To:收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "captain", "UTF-8"));
        // 4.Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject("博客注册", "UTF-8");
