        ...
        <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="17" :xl="17">
                <div class="write_abstract">
                    <h4>标题</h4>
                    <el-input v-model="write.titleValue" placeholder="文章标题" maxlength="50" show-word-limit
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="7" :xl="7">
                <div class="write_abstract">
                    ...
                    <el-input v-model="write.abstractValue" :autosize="{ minRows: 3, maxRows: 5 }" maxlength="200"
                        show-word-limit type="textarea" placeholder="文章简介" clearable />
                    <p>筛选文章主要内容，让读者初步了解文章</p>
                </div>
                <div class="write_abstract">
                    <h4>缩略图</h4>
                    <el-input size="large" v-model="write.thumbnailValue" placeholder="上传图片或输入图片地址">
                        <template #append>
                ...
                <div class="write_abstract">
                    <h4>分类</h4>
                    <el-select v-model="write.classifyValue" placeholder="文章分类" size="large">
