<template>
    <div class="backstage_home">
        <div class="top_bg">
            <h1>Don't be evil</h1>
            <p>唐朝杂货铺·欢迎您，{{userInfo.userName}}</p>
        </div>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="14" :xl="14">
                <div class="latest_article">
                    ...
                    <p class="article_list" v-for="item in articleInfo">
                        ...
                        <span>
                            <a
                                :href="'http://localhost:8081/articleDetails/' + item.articleId">{{item.articleTitle}}</a>
                        </span>
                    </p>
...
<script>
    ...
    export default {
        setup(props) {
            ...
            const calculateDays = () => {
                var day = Math.floor(new Date().getTime() / 1000) - (new Date('2023-03-10 00:00:00')
                        .getTime() /
                        1000),
